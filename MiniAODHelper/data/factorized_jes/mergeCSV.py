...
Type "./mergeCSV.py --help" to see all arguments.
...
> ./mergeCSV.py --file-prefix csv_rwt_fit_hf_v2_final_2017_6_7_
...
def main(directory, output_file, file_prefix, nominal_file, nominal_name, jes_name):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--nominal-file", default=None, help="path to the nominal file, when empty "
            "<directory>/<file-prefix><nominal-name>.root is used, default: None")
    ...
    # merge
    main(args.directory, args.output_file, args.file_prefix, args.nominal_file, args.nominal_name,
            args.jes_name)
